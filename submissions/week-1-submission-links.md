# Week 1 Submission Links

Use these public GitHub links after the changes are committed and pushed.
...
| --- | --- |
| Week 1 Learning Agent Setup | https://github.com/Connor532/ai-web3-school-cohort-0/blob/main/README.md |
| Week 1 GitHub learning repo | https://github.com/Connor532/ai-web3-school-cohort-0 |
| Week 1 tool preparation | https://github.com/Connor532/ai-web3-school-cohort-0/blob/main/tasks/week-1-tools.md |
| X start post draft | https://github.com/Connor532/ai-web3-school-cohort-0/blob/main/drafts/week-1-x-start-post.md |
| Community intro draft | https://github.com/Connor532/ai-web3-school-cohort-0/blob/main/drafts/week-1-community-intro.md |
...
| AI interactive learning artifact | https://github.com/Connor532/ai-web3-school-cohort-0/blob/main/demos/week-1-concept-quiz.html |
...
| Minimal smart contract | https://github.com/Connor532/ai-web3-school-cohort-0/blob/main/tasks/week-1-minimal-contract.md |
...
- For tasks that require wallet signatures, testnet transactions, or contract deployment, only submit after completing the action personally and recording public hashes or explorer links.
- Do not submit seed phrases, private keys, API keys, `.env` files, tokens, private meeting links, or non-public course links.
